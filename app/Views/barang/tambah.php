            ...
            <form action="/barang/save" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-10">
                        ...
                        <input type="text" class="form-control rupiah <?= ($validation->hasError('harga_beli')) ? 'is-invalid' : ''; ?>" id="harga_beli" name="harga_beli" value="<?= old('harga_beli'); ?>" onkeyup="splitInDots(this)">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-10">
                        ...
                        <input type="text" class="form-control rupiah <?= ($validation->hasError('harga_jual')) ? 'is-invalid' : ''; ?>" id="harga_jual" name="harga_jual" value="<?= old('harga_jual'); ?>" onkeyup="splitInDots(this)">
                        <div class="invalid-feedback">
