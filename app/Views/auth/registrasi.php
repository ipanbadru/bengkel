                ...
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <?php endif; ?>
                            <form role="form" action="/auth/registerAccount" method="post">
                                <div class="form-group mb-3">
                                    ...
                                    <small class="text text-danger"><?= $validation->getError('nama'); ?></small>
                                </div>
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="text text-danger"><?= $validation->getError('password1'); ?></small>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        <div class="input-group-prepend">
                                    ...
                                    <small class="text text-danger"><?= $validation->getError('password2'); ?></small>
                                </div>
